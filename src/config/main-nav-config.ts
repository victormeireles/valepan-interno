...
export const MAIN_NAV_ENTRIES: MainNavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      match: (pathname) => pathname === '/pessoas',
    },
    {
      type: 'link',
      href: '/pessoas/quadro',
      ...
      icon: 'groups',
      moduloId: 'interno_pessoas',
      match: (pathname) => pathname.startsWith('/pessoas/quadro'),
    },
    {
      type: 'link',
      href: '/pessoas/faltas',
      ...
      icon: 'event_busy',
      moduloId: 'interno_pessoas',
      match: (pathname) => pathname.startsWith('/pessoas/faltas'),
    },
    {
      type: 'link',
      href: '/pessoas/extras',
      ...
      icon: 'schedule',
      moduloId: 'interno_pessoas',
      match: (pathname) => pathname.startsWith('/pessoas/extras'),
    },
    {
      type: 'link',
      href: '/pessoas/painel',
      ...
      icon: 'dashboard',
      moduloId: 'interno_pessoas',
      match: (pathname) => pathname.startsWith('/pessoas/painel'),
    },
  ],
},
  {
